...
| Detector_Box.stl         | RicochetBoxMesh       | Detector base reference  | X[-32.5,32.5] Y[-32.5,32.5] Z[-3,34.5] | G4_Cu    | DetectorBoxAssemblyLogical | Fused base and cover; detector reference at (13.1,-35.5,-76.75) mm in cryostat frame |

The Sn detector cube is CSG, not a mesh: `19.3 x 19.3 x 15.4 mm`, with its
bottom face at `z=5.2 mm`, 1.7 mm above the detector-box floor at `z=3.5 mm`.

The platform origin is at `z=-3.1 mm` relative to the detector-box origin. Its
upper surface is at `z=-3.0 mm`, leaving 0.1 mm clearance below the box.
